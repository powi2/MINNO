...
// Datalog
	if(OPCODE==4200)
	{
		...
		{
			PiDatalog(func, A_BVDSS_7x_STR1,	BVDSS_STR1,		 set_fail_bin,	POWER_UNIT);
			PiDatalog(func, A_BVDSS_7x_STR2,	BVDSS_STR2,		 set_fail_bin,	POWER_UNIT);
		}
	...
	if(gBVD_Room < 700) //650V device
		...
		PiDatalog(func, A_BVD_7x_100UA,		BVD_100UA,		 set_fail_bin,	POWER_UNIT);
