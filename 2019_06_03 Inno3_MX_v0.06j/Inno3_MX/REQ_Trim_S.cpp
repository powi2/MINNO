...
void REQ_Trim_S(test_function& func)
{
	...
	trim_plotcode = (trim_needed + 0.0004454) / 0.007178;	// obtained from measurements 25 DUT 5 Jan 2018
	//trim_plotcode = (trim_needed + 0.0007894) / 0.006748;	// obtained from measurements 150 DUT 9 Apr 2019
