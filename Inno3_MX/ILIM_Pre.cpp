...
void ILIM_Pre(test_function& func)
{
	...
	INNO_Gage_ChanAB_setup(0.15);	// Only do it when SAMPLE_SIZE is diff from previous. Each input control and trig control function takes 4ms. 		
	...
	if (ILIM_Pt_P > 99) gILIM_I2f_pt_S = DEFAULT_VALUE;
